...
from readwise_sqlalchemy.main import main, hello_name
...
@patch("readwise_sqlalchemy.main.set_name", return_value="Chris")
def test_hello_name(mock_set_world):
    actual = hello_name()
    assert actual == "Hello Chris"
