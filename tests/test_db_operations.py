...
def test_create_database_tables(mock_user_config):
...
def test_get_session(mock_user_config):
...
def test_get_session_database_url(mock_user_config):
...
# # TODO: the tests revised to match new classes implementations & relationships.
