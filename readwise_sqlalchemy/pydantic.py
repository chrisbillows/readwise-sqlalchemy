...
class BookSchema(BaseModel):
    ...
    # Undocumented. Assume same as 'title'
    readable_title: str = Field(max_length=511)
    # # Undocumented. Using documentation for 'source_type'
    # source: Optional[str] = Field(None, min_length=3, max_length=64)
...
for book in data:  
    try:
        ...
        print(f"🚨 Validation error for book {book['title']}: {e}")
